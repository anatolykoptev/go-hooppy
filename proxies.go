...
func (c *Client) ListProxies(ctx context.Context) (*ProxiesResponse, error) {
	...
	if err := c.doGET(ctx, pathProxies, nil, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (c *Client) UpdateProxy(ctx context.Context, id int, payload ProxyPayload) (*ProxyResponse, error) {
	var resp ProxyResponse
	if err := c.doPUT(ctx, fmt.Sprintf(pathProxyByID, id), payload, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (c *Client) DeleteProxy(ctx context.Context, id int) (*ProxyResponse, error) {
	var resp ProxyResponse
	if err := c.doDELETE(ctx, fmt.Sprintf(pathProxyByID, id), &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
